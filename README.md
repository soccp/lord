...
* Latest - v2.1.0 - `soccp/lord:latest` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.0.8).

* Stable - v2.1.0 - `soccp/lord:stable` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.0.8).
